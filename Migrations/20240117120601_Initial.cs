    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, true, 1, new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Project A", "In Progress", 10 });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "ProjectID", "Active", "ClientLocationID", "DateOfStart", "ProjectName", "Status", "TeamSize" },
                values: new object[] { 2, false, 2, new DateTime(2022, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Project B", "Completed", 8 });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "ProjectID", "Active", "ClientLocationID", "DateOfStart", "ProjectName", "Status", "TeamSize" },
                values: new object[] { 3, true, 3, new DateTime(2022, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Project C", "On Hold", 15 });
